...
| ⬜ 検討中 | 「自分を置く」スケール確認用オブジェクト機能 | Keepa前の無料タスク候補 | 身長入力(120-220cm,初期170cm)→人物オブジェクトを部屋に配置(2D:上面アイコン/3D:簡易人型)、家具・買い物リストには含めない、localStorage/共有URLには含める。オーナー提案、優先度確認待ち |
